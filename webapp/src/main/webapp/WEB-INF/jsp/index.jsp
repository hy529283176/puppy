	...
	<body>
		...
		<div class="dvcontent">
			...
			<ul class="ulleftmenu" style="border-right: 1px solid #ddd;">
				...
				<li class="limenuitem">
					...
					<ul class="ulleftsubitems">
						<a href="${pageContext.request.contextPath}/doType/getIndex" target="right">
							<li>分类管理</li>
						</a>
						<a href="${pageContext.request.contextPath}/doInventory/getIndex" target="right">
							<li>库存管理</li>
						</a>
						<a href="${pageContext.request.contextPath}/doInBound/getIndex" target="right">
							<li>入库管理</li>
						</a>
						<a href="${pageContext.request.contextPath}/doWaring/getIndex" target="right">
							<li>预警信息设置</li>
						</a>
						<a href="${pageContext.request.contextPath}/doOutBound/getIndex" target="right">
							<li>出库管理</li>
						</a>
						<a href="${pageContext.request.contextPath}/doUserManager/getIndex" target="right">
							<li>用户管理</li>
						</a>
			...
			<div style="position: absolute; left: 191px; right: 20px; ">
				<iframe src="${pageContext.request.contextPath}/doType/getIndex" scrolling="no"  width="100%" height="1200" name="right" border="none"></iframe>
			</div>
		</div>
